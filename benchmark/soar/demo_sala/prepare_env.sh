...
export SOAR_GPTQ_INCLUDE_MODULES="${SOAR_GPTQ_INCLUDE_MODULES:-self_attn.q_proj,self_attn.v_proj,self_attn.o_proj,mlp.gate_proj,mlp.up_proj,mlp.down_proj}"
export SOAR_GPTQ_EXCLUDE_MODULES="${SOAR_GPTQ_EXCLUDE_MODULES:-self_attn.k_proj,self_attn.o_gate,self_attn.z_proj}"
